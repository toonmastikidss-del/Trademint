...
import { ChevronLeft, QrCode, Info, Copy, AlertCircle, CheckCircle, Upload, X, CreditCard, Landmark, User, Hash, Banknote } from 'lucide-react';
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm mt-4">
            {qrCodeData?.paymentMode === 'account' ? 'Transfer to bank account details below' : 'Use Mobile Scan code to pay'}
          </p>
        </div>

        {/* Payment Details Section - QR or Account */}
        <div className="bg-white rounded-lg p-8 mb-8 shadow-sm border border-gray-100">
          {qrLoading ? (
            <div className="flex items-center justify-center h-64">
              <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-purple-600"></div>
            </div>
          ) : qrCodeData?.paymentMode === 'account' ? (
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-4 border border-purple-100">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => copyToClipboard(qrCodeData.bankName, 'bankName')}
              ...
              <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-4 border border-blue-100">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => copyToClipboard(qrCodeData.accountName, 'accountName')}
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 border border-green-100">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => copyToClipboard(qrCodeData.accountNumber, 'accountNumber')}
              ...
              <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl p-4 border border-orange-100">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => copyToClipboard(qrCodeData.ifscCode, 'ifscCode')}
            ...
            <div className="mb-8">
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4">
                ...
                <p className="text-xs text-green-700">
                  Please transfer the exact amount to the bank account shown above and enter your 12-digit Ref No (UTR) below.
                </p>
              </div>
            </div>
          )}
