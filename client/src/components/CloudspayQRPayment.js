...
const CloudspayQRPayment = () => {
      ...
      try {
        ...
        if (generalQr) {
          ...
          if (generalQr.upiId) {
            ...
            setDynamicUpiId('cloudspay@merchant789'); // Fallback
          }
        }
      } catch (error) {
  ...
  const handleCopyUPI = () => {
    const upiIdToCopy = dynamicUpiId || 'cloudspay@merchant789';
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <button 
                ...
                className="bg-blue-600 text-white px-4 py-3 rounded-xl font-bold text-sm hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {copied ? 'COPIED' : 'COPY'}
              </button>
            </div>
