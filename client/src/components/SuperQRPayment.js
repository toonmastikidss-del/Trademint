...
const SuperQRPayment = () => {
  ...
  return (
    <div className="bg-[#101821] min-h-screen text-white pb-24 font-sans">
      {/* Header */}
      <div className="sticky top-0 z-50 bg-green-600 px-4 py-4 flex items-center justify-between">
        <button onClick={() => navigate('/deposite')} className="p-1">
          <ChevronLeft size={24} className="text-white" />
        </button>
        <h1 className="text-lg font-bold tracking-tight">Super-QR Payment</h1>
      ...
      <div className="px-4 mt-6 space-y-6">
        ...
        <div className="bg-[#212431] border border-gray-700 rounded-3xl p-6 shadow-xl">
          ...
          <div className="flex items-center justify-between">
            <span className="text-3xl font-black text-green-500">₹{amount}</span>
        ...
        <div className="bg-[#212431] border border-gray-700 rounded-3xl p-6 shadow-xl text-center">
          ...
          <div className="text-left space-y-3 text-sm text-gray-400">
            <p>1. For iOS phones, long press the QR code and enter SuperPay wallet</p>
            <p>2. For Android phones, take a screenshot and manually open SuperPay wallet to upload the QR code</p>
        ...
        <div className="bg-[#212431] border border-gray-700 rounded-3xl p-6 shadow-xl">
          ...
          {/* Step 1: Copy UPI */}
          <div className="mb-6">
            <p className="text-sm text-gray-400 mb-2">1. Copy the below given SuperPay ID</p>
            ...
            <p className="text-xs text-orange-400 mt-2">Dont save the SuperPay ID, get new ID every time.</p>
          </div>
          ...
          <div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-col items-center justify-center gap-3">
                      ...
                      <label 
                        ...
                        className="px-4 py-2 bg-green-600 text-white text-xs font-bold rounded-lg cursor-pointer hover:bg-green-700 transition-colors"
                      >
                        Choose File
                      </label>
                    </div>
            ...
            <p className="text-xs text-orange-400 mt-2">
              Open your SuperPay wallet and complete the transfer. Record your reference No. (Ref No.) after payment.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[#212431] border border-gray-700 rounded-3xl p-6 shadow-xl">
          ...
          <ul className="space-y-2 text-sm text-gray-400">
            <li className="flex items-start gap-2">
              ...
              <span>Please select the payment method you need and make sure your phone has SuperPay wallet installed.</span>
            </li>
          </ul>
        </div>
      </div>
