...
const UmoneyQRPayment = () => {
  ...
  const handleCopyUPI = () => {
    navigator.clipboard.writeText('umoney@merchant123');
    setCopied(true);
        ...
        <div className="bg-[#212431] border border-gray-700 rounded-3xl p-6 shadow-xl">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-2">
              <input 
                type="text" 
                value="umoney@merchant123" 
                readOnly
                className="flex-1 bg-[#1a1f2e] border border-gray-800 rounded-xl px-4 py-3 text-sm font-medium"
              />
              <button 
                onClick={handleCopyUPI}
                className="bg-purple-600 text-white px-4 py-3 rounded-xl font-bold text-sm hover:bg-purple-700 transition-colors"
              >
                {copied ? 'COPIED' : 'COPY'}
              </button>
            </div>
